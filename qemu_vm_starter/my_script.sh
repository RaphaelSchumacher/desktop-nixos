...
qemu-system-x86_64 \
    ...
    -object input-linux,id=mouse1,evdev=/dev/input/by-id/usb-Logitech_USB_Receiver-if02-event-mouse,grab_all=yes \
...
tehrafff@nixos:~/Projects/vfio/ > vim startvm.sh 
tehrafff@nixos:~/Projects/vfio/ > cat startvm.sh 
TAP='macvtap0'
NETWORK="-device e1000,netdev=net0,mac=52:54:00:a1:89:8b -netdev tap,ifname=${TAP},id=net0,script=no"
